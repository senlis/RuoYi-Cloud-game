 ...
 * @author ruoyi
 */
public interface GameFieldDefineMapper
{
    /**
     * 查询动态字段定义列表
     *
     ...
     * @return 动态字段定义集合
     */
    public List<GameFieldDefine> selectGameFieldDefineByEntity(String entityType);
     ...
     * @return 结果
     */
    public int deleteGameFieldDefineById(Long fieldId);
